...
import coverMiniCalculator from '/src/assets/Images/Cover_MiniCalculator.png';
...
const projects: Project[] = [
  ...
  // المشاريع الجديدة
  {
    ...
    shortDesc: 'Comprehensive console-based calculator offering 30+ mathematical operations with beautiful formatting and intuitive menus.',
    features: [
    ...
    techTags: ['C++', 'POP', 'Console', 'Math'],
    langFilter: ['cpp'],
    typeFilter: ['console'],
    github: 'https://github.com/7mee3d/MiniCalculator',
  ...
  },
  {
    id: 'datetoolkit',
    title: 'DateToolkit',
    shortDesc: 'Comprehensive C++ library for manipulating dates without external dependencies.',
    features: [
    ...
    techTags: ['C++', 'Library', 'POP', 'Date'],
    langFilter: ['cpp'],
    typeFilter: ['library'],
    github: 'https://github.com/7mee3d/DateToolkit',
  ...
  },
  {
    id: 'stringutils',
    title: 'StringUtils',
    shortDesc: 'Lightweight C++ library for string manipulation in an object-oriented style.',
    features: [
      'String Trimming',
      'Case Conversion',
      'Character Counting',
    ...
    techTags: ['C++', 'Library', 'POP', 'String'],
    langFilter: ['cpp'],
    typeFilter: ['library'],
    github: 'https://github.com/7mee3d/StringUtils',
  ...
  },
  {
    ...
    shortDesc: 'Simple C++ library to safely read and validate user input in console applications.',
    features: [
      'Input Validation',
      'Error Prevention',
      'Type Safety',
    ...
    techTags: ['C++', 'Library', 'Validation', 'Console'],
    langFilter: ['cpp'],
    typeFilter: ['library'],
      ...
      <footer className="py-20 px-6 border-t border-white/5">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-8">
          ...
          <div className="flex gap-6">
            ...
            <a
              href="https://www.youtube.com/@AhmedJehhad"
              target="_blank"
              rel="noopener noreferrer"
